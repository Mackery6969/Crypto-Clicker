...
class KilidoorBossState extends FlxState
{
	...
	override public function create()
	{
		...
		fightButton = new FlxButton(0, 0, "Fight", function()
		{
			killKilidoor();
		});
		...
		actButton = new FlxButton(0, 0, "Act", function()
		{
			glitchedOptions();
		});
		...
		itemButton = new FlxButton(0, 0, "Item", function()
		{
			glitchedOptions();
		});
		...
		mercyButton = new FlxButton(0, 0, "Mercy", function()
		{
			glitchedOptions();
		});
